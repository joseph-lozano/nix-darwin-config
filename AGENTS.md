...
- Home Manager configures mise with Node LTS and pnpm globally. Other runtimes belong in each project's `mise.toml`; do not add another global runtime unless explicitly requested.
